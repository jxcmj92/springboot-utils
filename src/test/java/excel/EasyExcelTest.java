...
//
//    private static final String filePath = "C:\\学习资料/test.xlsx";
//
//    /**
//     * 读取少于1000行的excel
//     */
...
//        List<List<List<String>>> objects = EasyExcelUtil.readLessThan1000Row("C:\\学习资料/test.xlsx");
...
//        Sheet sheet = new Sheet(1, 1, TableHeaderExcelProperty.class);
//        List<TableHeaderExcelProperty> objects = EasyExcelUtil.readLessThan1000Row(filePath,sheet);
//
